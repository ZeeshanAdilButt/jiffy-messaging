 ...
 * whatever adapters the host passes in. The standalone server built in a
 * later phase wires the same ports into HTTP and WebSocket instead - this
 * is the other side of that boundary, for hosts that would rather call
 * this in-process than run it as a separate service.
 */
